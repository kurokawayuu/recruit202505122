...
<div class="edit-job-container">
    ...
    <div class="address-container">
        <div class="address-row">
            ...
            <input type="text" id="facility_zipcode" name="facility_zipcode" value="<?php echo esc_attr(get_post_meta($job_id, 'facility_zipcode', true)); ?>" placeholder="123-4567">
        </div>
    ...
    <p class="form-hint">※ 「勤務地域」セクションで選択した都道府県・市区町村が反映されます</p>
        ...
        <div class="address-row">
            ...
            <input type="text" id="facility_address_detail" name="facility_address_detail" value="<?php echo esc_attr(get_post_meta($job_id, 'facility_address_detail', true)); ?>" placeholder="○○町1-2-3 △△ビル5階" required>
        </div>
    </div>
</div>
